...
class DisciplinaController {
	...
	public DisciplinaController() {
		...
		disciplinas.add(new Disciplina(1, "Erick Santos", "S", "Sistemas", 3));
		disciplinas.add(new Disciplina(2, "Herdz", "C", "PP", 2));
		disciplinas.add(new Disciplina(3, "Paluh", "D", "Medicina", 4));
	}
